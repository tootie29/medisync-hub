...
Now let's update the PDFShareDialog to use actual email sending:

<lov-write file_path="src/components/pdf/PDFShareDialog.tsx">
    ...
    try {
      ...
      reader.onloadend = async () => {
        try {
          ...
          // Reset form
          setEmail('');
          setMessage(`Please find attached the Orange Card for ${patientName}.`);
          setIsOpen(false);
        } catch (error) {
